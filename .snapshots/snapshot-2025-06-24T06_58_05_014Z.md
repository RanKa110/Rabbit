...
public class RangedMonster : MonsterBase
{
    ...
    protected override void Start()
    {
        ...
        {
            // SO에서 프리팹 가져오기
            if (enemyController.Data.ProjectilePrefab != null)
            {
                projectilePrefab = enemyController.Data.ProjectilePrefab;
                Debug.Log($"RangedMonster: Projectile prefab loaded from SO: {projectilePrefab.name}");
            }
            else
            {
                Debug.LogWarning("RangedMonster: ProjectilePrefab is null in EnemySO!");
            }
        }
    ...
    private void FireProjectile()
    {
        ...
        {
            Debug.LogWarning($"RangedMonster: Cannot fire projectile! Prefab: {projectilePrefab}, FirePoint: {firePoint}");
        }
    }
